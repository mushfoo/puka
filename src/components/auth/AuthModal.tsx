  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.user) {
        ...
        // The onSuccess callback in auth-client will handle closing the modal
        // and updating the auth state via useAuth context.
      }
    } catch (error: any) {
          ...
          <div className='mt-4 text-center'>
            {activeTab === 'signup' && (
              <p className='text-sm text-gray-600'>
                By creating an account, you agree to sync your reading data
                securely.
              </p>
            )}
          </div>
