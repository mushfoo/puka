...
import { createStorageService, resetStorageService, getCurrentStorageServiceType } from '../index';
...
describe('Storage Service Factory', () => {
  ...
  describe('Health Check', () => {
    it('should perform health check before creating DatabaseStorageService', async () => {
      ...
      vi.spyOn(DatabaseStorageService.prototype, 'initialize').mockResolvedValueOnce();
    ...
    it('should fallback to MockStorageService when health check fails', async () => {
      ...
      vi.spyOn(MockStorageService.prototype, 'initialize').mockResolvedValueOnce();
  ...
  describe('Service Initialization Failures', () => {
    it('should fallback to MockStorageService when DatabaseStorageService initialization fails', async () => {
      ...
      vi.spyOn(DatabaseStorageService.prototype, 'initialize').mockRejectedValueOnce(
  ...
  describe('Service Caching', () => {
    ...
    it('should create new instance after reset', async () => {
      ...
      // Mock DatabaseStorageService.initialize
      const initSpy = vi.spyOn(DatabaseStorageService.prototype, 'initialize')
        .mockResolvedValue();
